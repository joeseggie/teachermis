...
namespace EastSeat.TeacherMIS.Web.Controllers
{
    ...
    public class PositionsController : Controller
    {
        ...
        {
            var model = _db.Positions.Select(p => new PositionViewModel{
        ...
        public async Task<IActionResult> Add(PositionViewModel formData)
        {
            if (ModelState.IsValid)
            {
                await _db.Positions.AddAsync(new Position{
                    Name = formData.Name
                });
