...
namespace EastSeat.TeacherMIS.Web.Migrations
{
    ...
    [Migration("20170810134231_SchoolHeadmasterTeacher")]
    partial class SchoolHeadmasterTeacher
    {
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.Headmaster", b =>
                {
                    ...
                    b.HasOne("EastSeat.TeacherMIS.Web.Models.Teacher", "Teacher")
                        .WithOne("Headmaster")
                        .HasForeignKey("EastSeat.TeacherMIS.Web.Models.Headmaster", "TeacherId1");
                });
