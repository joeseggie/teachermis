...
namespace EastSeat.TeacherMIS.Web.Migrations
{
    ...
    [Migration("20170906071737_TeacherGradeAndPosition")]
    partial class TeacherGradeAndPosition
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.District", b =>
                {
                    ...
                    b.Property<decimal?>("WageAllocation")
                        .HasAnnotation("SqlServer:ColumnType", "money");
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.Grade", b =>
                {
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasMaxLength(256)
                        .IsUnicode(false)
                        .HasAnnotation("SqlServer:ColumnType", "varchar(256)");
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.Position", b =>
                {
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.SchoolCategory", b =>
                {
                    b.Property<Guid>("SchoolCategoryId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.School", b =>
                {
                    b.HasOne("EastSeat.TeacherMIS.Web.Models.District", "District")
                        .WithMany("Schools")
                        .HasForeignKey("DistrictId");

                    b.HasOne("EastSeat.TeacherMIS.Web.Models.SchoolCategory", "SchoolCategory")
                        .WithMany("Schools")
            ...
            modelBuilder.Entity("EastSeat.TeacherMIS.Web.Models.Teacher", b =>
                {
                    b.HasOne("EastSeat.TeacherMIS.Web.Models.Grade", "Grade")
                        .WithMany("Teachers")
                        .HasForeignKey("GradeId");

                    b.HasOne("EastSeat.TeacherMIS.Web.Models.Position", "Position")
                        .WithMany("Teachers")
